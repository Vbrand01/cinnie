                ...
                <div class="col-xl-12">
                    <section class="block gap-1">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xl-12">
                                    <h3 class="title-genre">Filmes de ficção científica</h3>
                                </div>
                            </div>
                        </div>
                        <div class="inline">
                            <ul id="scrollerFiccao" class="UserList Scroller inline gap-2">
                        ...
                        <div class="Controls block-center-center">
                            <div class="Wrapper inline content-3 space-between"> <button id="PrevBtn"
                                    ...
                                    onclick="scrollerFiccao.scrollBy(-600, 0)"> <svg viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor">
                                        <path d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
                                    </svg> </button> <button id="NextBtn" class="ControlsBtn next"
                                    aria-label="Next item" title="Next item" onclick="scrollerFiccao.scrollBy(600, 0)">
