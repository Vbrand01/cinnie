<template>
    <div>
        <div class="container" id="comedia">
            <div class="row">
                <div class="col-xl-12">
                    <section class="block gap-1">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-xl-12">
                                    <h3 class="title-genre">Filmes de comédia</h3>
                                </div>
                            </div>
                        </div>
                        <div class="inline">
                            <ul id="scrollerComedia" class="UserList Scroller inline gap-2">
